        ...
        if self.action == "list":
            ...
            if sales_member:
                queryset = queryset.filter(
                    sales_member__first_name__icontains=sales_member
                )
        return queryset


class CustomerViewSet(
    mx.OrObjectPermissionMixin, mx.QuerysetFilterMixin, CustomModelViewSet
):
...
class EventViewSet(mx.OrObjectPermissionMixin, CustomModelViewSet):
    ...
    def get_queryset(self):
        ...
        if self.action == "list":
            ...
            if support_member:
                queryset = queryset.filter(
                    sales_member__first_name__icontains=support_member
                )
        return queryset
